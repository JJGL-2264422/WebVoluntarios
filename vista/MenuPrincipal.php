 ...
 ?><br>
    <div class="container text-center">
        <div class="row ">
            ...
            <div class="col">
                <div>
                    <h1>Voluntariados S.A</h1>
                </div>
                <div>
                Bienvenidos a Voluntariados S.A <br>
        ...
        <div class="bg-secondary">
            <div class="container text-center ">
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4">
                    <div class="col"><h5>Desarrolladores</h5> <br>Cristian Martines <br>Juan Jose Garcia <br>Christian Trujillo </div>
                    <div class="col"><h5>¿Quienes somos?</h5><br> dirigete a nuestra seccion <br> de "¿Quienes somos?"</div>
                    <div class="col"><h5>Contactanos</h5><br> ° 3188943014 <br>°cristian.daniel.martinez@correounivalle.edu.co <br>° 2397362</div>
                    <div class="col"><h5>Ubicanos</h5><br>° carrea 13 #5-25</div>                    
                </div>
            </div>  
        </div>
    </footer>
