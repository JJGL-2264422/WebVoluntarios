        ...
        <div class="main">
            <div class="row d-flex">
                    ...
                    <div class="card mb-3 content" style="padding:10px;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-end align-items-end" style="margin-bottom:-20px">
                                ...
                                <!-- Boton Cerrar -->
                                <form method="POST" action="">
                                  <button type="submit" name="cerrar" class="btn btn-secondary m-3">Cerrar</butto>
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4 mt-1">
                    <div class="card bg-secundary h-100 inscritos-card">
                        <h5>Inscritos</h5>
                          ...
                          <?php if ($inscritos): ?>
                            <?php foreach ($inscritos as $inscrito): ?>
                              <li>
                                ...
                                <?php
                                //Estrellas
                                $valoracion = intval($inscrito['valoracion']);
                                for ($i = 1; $i <= 5; $i++): ?>
                                  <span class="fa fa-star<?php echo $i > $valoracion ? '-o' : ''; ?>"></spa>
                                <?php endfor; ?>
                              </li>
                            <?php endforeach; ?>
                          <?php else: ?>
