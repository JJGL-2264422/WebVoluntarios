    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="etiquetasModalLabel">Etiquetas: ¿En qué eres bueno?</h5>
            </div>
            <form method="post">
                <div class="modal-body">
                    <div class="text-center" style="margin:-5px;padding-bottom:7px; padding-top:7px;border:3px solid #454545">
